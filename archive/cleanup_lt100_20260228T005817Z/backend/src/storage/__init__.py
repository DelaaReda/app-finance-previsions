...
# Ensure submodules (io, ttl, etc.) resolve from the real backend/storage package
backend_storage_dir = backend_root / 'storage'
__path__ = extend_path(__path__, __name__)
if str(backend_storage_dir) not in __path__:
    __path__.append(str(backend_storage_dir))
