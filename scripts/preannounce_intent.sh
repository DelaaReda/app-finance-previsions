...
Examples:
  scripts/preannounce_intent.sh preannounce --role backend_engineer --scope api_forecast_contract --files docs/planning/tasks.md,copilot-app/backend/src/api/main.py --eta-minutes 25
