...
TS="$(date +%Y%m%d-%H%M%S)"
CRON_TIMEOUT_SECONDS="${CRON_TIMEOUT_SECONDS:-480}"
ROLE_PROMPT_TIMEOUT_SECONDS="${ROLE_PROMPT_TIMEOUT_SECONDS:-55}"
ROLE_RETRY_PROMPT_TIMEOUT_SECONDS="${ROLE_RETRY_PROMPT_TIMEOUT_SECONDS:-30}"
...
ROLE_STALL_ABORT_SECONDS="${ROLE_STALL_ABORT_SECONDS:-0}"
...
ROLE_CODEX_MODEL="${ROLE_CODEX_MODEL:-gpt-5.3-codex}"
