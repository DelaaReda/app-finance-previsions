...
- [x] Mise en place bandeau explicite "snapshot indisponible" avec horodatage et bouton réessayer (FC-UI-006)
...
- [x] Création service de recalcul des indicateurs techniques manquants (SMA/RSI) à partir des données de prix (FC-DATA-005)
- [x] Création tests E2E Playwright vérifiant que chaque page affiche un état non-vide ou empty-state propre (TEST-001)
- [x] Mise en place job de materialization quotidien pour générer cache de forecasts rapidement accessible (FC-DATA-004)
...
- [x] Mise en place composant SourceTooltip pour la transparence des sources de données (FRED, yfinance, RSS) (FC-UI-010)
