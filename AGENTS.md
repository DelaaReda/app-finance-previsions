...
## Execution Trace (Compact WhatsApp)

In direct chat with the owner (+14389799898), keep WhatsApp replies compact and readable.

Required footer (max 5 lines):
Execution Trace
- Actions: <short summary, not full shell transcripts>
- Files changed: <count + key files or none>
- Files read: <key files only or none>
- Network/API calls: <hosts/endpoints only or none>

Rules:
- Never dump long command lists into WhatsApp.
- Put full technical detail in Control UI/TUI/logs, not in chat.
- Keep the whole trace footer under ~500 characters.
