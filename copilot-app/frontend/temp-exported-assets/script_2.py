...
# Créer un exemple de composant React avec le nouveau design
...
# Sauvegarder le fichier d'exemples React
with open('react-components-examples.tsx', 'w', encoding='utf-8') as f:
    f.write(react_component_example)

print("✅ Fichier d'exemples React créé: react-components-examples.tsx")
print(f"📝 Nombre de lignes: {len(react_component_example.splitlines())}")
print("\n🎨 Composants créés:")
print("   1. OpportunityCard - Card avec glassmorphism + hover glow")
print("   2. OpportunitiesSection - Section avec grille responsive")
print("   3. StocksTable - Table moderne avec hover effects")
print("   4. MetricCard - Card avec animated gradient border")
print("   5. PerformanceMetrics - Grille de métriques")
