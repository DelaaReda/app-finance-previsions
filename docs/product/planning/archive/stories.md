...
- **Fichiers cibles**:
  - `apps/api/src/domains/judge/api/main.py`
  - `apps/api/src/domains/judge/core/downsample.py`
  - `apps/api/tests/` (nouveau test stocks)
- **Plan implémentation**:
...
- **Fichiers cibles**:
  - `apps/api/src/domains/judge/api/main.py`
  - `apps/api/src/domains/judge/api/services/news_service.py`
  - `apps/api/tests/` (nouveau test news)
- **Plan implémentation**:
...
- **Fichiers cibles**:
  ...
  - `apps/api/src/domains/judge/api/main.py`
  - `apps/api/tests/` (nouveau test forecasts)
- **Plan implémentation**:
...
- **Fichiers cibles**:
  - `apps/api/src/domains/judge/api/main.py`
  - `apps/api/src/domains/judge/research/llm_client.py`
  - `apps/api/tests/` (nouveau test copilot ask)
- **Plan implémentation**:
