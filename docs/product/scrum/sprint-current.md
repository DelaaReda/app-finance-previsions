...
- Queue state current (source of truth: `docs/orchestrator-ops/priority-queue.json`):
  - `BATCH-01=PASS`
  - `BATCH-02=PASS` avec `next_action=CLOSE_BATCH02_AND_PREPARE_NEXT_PRIORITY_BATCH`
- Note: en cas de reprise future, toute ré-ouverture doit être explicitement tracée avec nouvel artifact de gate.
