...
- Timestamp (UTC): 2026-03-10T14:07:20Z
...
4. `bash scripts/stale_cron_sweep.sh --dry-run`
   - `SWEEP_SUMMARY matched=0 stale=0 reset_ok=0 reset_failed=0 skipped_live=0 skipped_timeout=0 threshold_s=330 timeout_grace_s=30 apply=0`
