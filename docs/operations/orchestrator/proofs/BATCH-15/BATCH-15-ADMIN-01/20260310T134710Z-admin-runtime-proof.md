...
- Timestamp (UTC): 2026-03-10T13:47:10Z
...
- Remaining degradation is shared observability noise, not a task-scoped blocker:
  - `health_snapshot.sh` still marks planner staleness.
  - `fc_doctor.sh --json` still reports a global degraded summary even when the lane-specific checks are green.
