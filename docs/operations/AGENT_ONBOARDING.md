...
1. [`README.md`](/home/venom/analyse-financiere/README.md) pour la vue produit.
2. [`docs/architecture/ARCHITECTURE_MAP.md`](/home/venom/analyse-financiere/docs/architecture/ARCHITECTURE_MAP.md).
3. [`docs/architecture/ARCHITECTURE_STYLE_GUIDE.md`](/home/venom/analyse-financiere/docs/architecture/ARCHITECTURE_STYLE_GUIDE.md).
4. [`docs/architecture/TARGET_ARCHITECTURE_LAYOUT.md`](/home/venom/analyse-financiere/docs/architecture/TARGET_ARCHITECTURE_LAYOUT.md).
5. [`docs/operations/ops/AGENT_WORKSPACE_INDEX.md`](/home/venom/analyse-financiere/docs/operations/ops/AGENT_WORKSPACE_INDEX.md).
6. `docs/planning/*` pour les tâches actives (WORKSTATE → epics → stories → tasks).
