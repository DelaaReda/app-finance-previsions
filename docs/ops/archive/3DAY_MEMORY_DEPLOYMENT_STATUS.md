...
superseded_by:
  - /home/venom/analyse-financiere/docs/ops/ROLE_MEMORY_STRATEGY_3DAY.md
...
Historical note:
- deployment snapshot from 2026-02-28
- useful for rollout history only
- current memory policy and runtime assumptions live in `docs/ops/ROLE_MEMORY_STRATEGY_3DAY.md` and current ops entrypoints
