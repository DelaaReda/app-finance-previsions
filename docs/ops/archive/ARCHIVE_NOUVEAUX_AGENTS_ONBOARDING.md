...
4. **📝 Validation Tri-Admin**
   ...
   - **FORMAT:** `docs/ops/ARCHIVE_TEAM_CHAT.md (general) or docs/ops/ADMIN_ARCHIVE_TEAM_CHAT.md (admins only)`
...
```bash
# 1. Vérifier approvals dans ADMIN_ARCHIVE_TEAM_CHAT.md
grep -A 10 "Extension.*APPROVED" docs/ops/ARCHIVE_TEAM_CHAT.md (general) or docs/ops/ADMIN_ARCHIVE_TEAM_CHAT.md (admins only)
...
# Rapport incident dans ADMIN_ARCHIVE_TEAM_CHAT.md
...
# Ajouter rapport dans docs/ops/ARCHIVE_TEAM_CHAT.md (general) or docs/ops/ADMIN_ARCHIVE_TEAM_CHAT.md (admins only)
...
# 6. Rapport incident
# Documenter dans docs/ops/ARCHIVE_TEAM_CHAT.md (general) or docs/ops/ADMIN_ARCHIVE_TEAM_CHAT.md (admins only)
