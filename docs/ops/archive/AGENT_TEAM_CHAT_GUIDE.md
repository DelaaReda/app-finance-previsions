...
superseded_by:
  ...
  - /home/venom/analyse-financiere/docs/ops/DOC_CLASSIFICATION_MATRIX.md
---
...
- useful only if legacy `TEAM_CHAT` helpers are still needed
- not a canonical runtime, planning, or delivery document
