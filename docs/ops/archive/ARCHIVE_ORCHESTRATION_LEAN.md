...
Status note:
- guide historique uniquement
- ne pas utiliser ce document pour definir le scheduling courant
- le mode canonique actuel est `planner` seul role planifie
- `dev`, `admin`, `scrum_master` sont des capabilities sous autorite planner
- en cas de conflit, `docs/ops/CANONICAL_RUNTIME_MODE.md` et `docs/ops/AGENTS_READY.md` gagnent
...
Historical note:
- La section ci-dessous decrit un palier transitoire ancien.
- Elle ne doit pas etre relue comme cible operative 2026-03-13.
