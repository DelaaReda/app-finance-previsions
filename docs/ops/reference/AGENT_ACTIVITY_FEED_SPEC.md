...
related_to:
  ...
  - /home/venom/analyse-financiere/docs/ops/reference/AGENT_ACTIVITY_OPERATIONS_RUNBOOK.md
---

# Agent Activity Feed Specification

Status note:
- reference spec for an optional monitor surface
- not a primary architecture entrypoint
- if monitor/runtime behavior conflicts, `MONITOR_ARCHITECTURE_SPEC.md` wins
