...
- applies to planner and planner-owned capability executions
- does not imply legacy multi-lane scheduling is canonical

## Scope
This spec defines mandatory issue reporting for planner and any planner-owned capability execution that emits a contract or evidence payload.
