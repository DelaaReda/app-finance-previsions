...
**Subject**: ARCHIVE_TEAM_CHAT.md created for general team communication
...
**Admin Chat** (`ADMIN_ARCHIVE_TEAM_CHAT.md`) is now reserved for:
...
- **Admin Chat**: `docs/ops/ADMIN_ARCHIVE_TEAM_CHAT.md`
...
You have access to ARCHIVE_TEAM_CHAT.md for team communication.
...
- Escalate to admin-agents via ADMIN_ARCHIVE_TEAM_CHAT.md
```
