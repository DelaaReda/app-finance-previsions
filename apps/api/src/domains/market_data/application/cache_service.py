...
from core.memory_cache import memory_cache, cache_get, cache_set, cache_invalidate
...
class CacheService:
    ...
    def invalidate_prefix(self, prefix: str):
        ...
        from core.memory_cache import invalidate_cache_prefix
    ...
    def invalidate_all(self):
        """Clear entire cache."""
        from core.memory_cache import cache_clear
        cache_clear()
...
def get_advanced_cache_freshness_info() -> Dict[str, Dict[str, Any]]:
    """Compatibility helper used by api/routes/cache_routes.py."""
    try:
...
def force_invalidate_cache(cache_key: str, reason: str = "manual_invalidation") -> bool:
    """Compatibility helper used by api/routes/cache_routes.py."""
    try:
        from jobs.cache_manager import CacheInvalidationTracker
