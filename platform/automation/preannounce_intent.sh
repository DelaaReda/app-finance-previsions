...
Examples:
  scripts/preannounce_intent.sh preannounce --role backend_engineer --scope api_forecast_contract --files docs/planning/tasks.md,apps/api/src/platform/main.py --eta-minutes 25
