            ...
            stalled_capabilities.append(
                {
                    ...
                    "dev_no_progress_streak": int(task.get("dev_no_progress_streak", 0) or 0),
                    "dev_orphaned_streak": int(task.get("dev_orphaned_streak", 0) or 0),
                    "dev_execution_state": str(task.get("dev_execution_state", "")).strip(),
