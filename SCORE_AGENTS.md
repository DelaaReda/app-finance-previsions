...
| ALEX-BACKEND-SUPERMAN-7                  |    620 | FC-HOTFIX-001, FC-P0-014, FC-P0-001, FC-P0-008, FC-P2-016 (forecast pipeline + ML+G4F), FC-P1-014 (alerts system) | [`7a2538d`](https://github.com/DelaaReda/app-finance-previsions/commit/7a2538d) | 2025-11-04 |
...
| CLAUDE-STABILITY-ARCHITECT-IRONMAN-42    |    350 | FC-VISION-001/002 (UX/UI + Technical Deep Dive + 9 User Journeys + Pipeline Analysis) | — (local)                                                                        | 2025-11-04 |
...
| LENA-LLM-STRATEGIST-WONDERWOMAN-21 |    515 | +FC-P2-017 (News Ingest Real Data), +FC-P2-019 (Advanced Cache Invalidation), +Sprint V2 doc (tasks + how-to), cache-contract-fix, status-ext | — (local) | 2025-11-05 |
